...
// -- Normally generated by `sea-orm-cli generate entity` --
mod entity {
...
async fn list_products(CurrentTenant(tenant): CurrentTenant) -> String {
    ...
    let _query = TenantFilter::filter(
        <entity::Entity as sea_orm::EntityTrait>::find(),
        &tenant,
    );
...
async fn main() {
    ...
    let resolver =
        CompositeTenantResolver::new().add(HeaderTenantResolver::default());
